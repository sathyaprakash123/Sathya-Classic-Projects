...
public class SoapServiceLocator extends org.apache.axis.client.Service implements soapWebServices.SoapService {
    ...
    private java.lang.String soap_address = "http://localhost:8080/SOAPExample/services/soap";
    ...
    public soapWebServices.Soap getsoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soapWebServices.SoapSoapBindingStub _stub = new soapWebServices.SoapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soapWebServices.Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                soapWebServices.SoapSoapBindingStub _stub = new soapWebServices.SoapSoapBindingStub(new java.net.URL(soap_address), this);
                _stub.setPortName(getsoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapWebServices", "soapService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapWebServices", "soap"));
        }
